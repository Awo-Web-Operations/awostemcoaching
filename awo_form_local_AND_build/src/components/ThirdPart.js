...
class ThirdPart extends React.Component {
  ...
  imgHandler = (event) => {
    ...
    window.location.href = "https://www.awosemcoaching.com";
  };
            ...
            <div className='jumbotron text-center rounded-0 border-0'>
              <div className='row'>
                <div className="col-md-4 offset-md-4">
                  <img className="img-fluid" src="./assets/img/header/AWO_WB_Logo_250x61.png" alt="awostemcoaching" onClick={this.imgHandler} />
                </div>
              </div>
              <p><a href="https://www.awostemcoaching.com">www.awostemcoaching.com</a></p>
