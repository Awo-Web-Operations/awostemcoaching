...
class ForthPart extends React.Component {
  ...
  createWinRateCustomerEmail = (firstName, lastName, phone, email, testUser,
    ...
    if (testUser || this.myReferer === "http://localhost:3000/" || this.myReferer === "http://localhost:5000/") {
      customerEmailSubjectTitle = `Test of Customer Email- Thank you for visiting awostemcoaching.com!`;
      adminEmailSubjectTitle = `Test of Customer Email- You have a new potential client!`;
    }
    else {
      customerEmailSubjectTitle = `Thank you for visiting awostemcoaching.com!`;
      adminEmailSubjectTitle = `You have a new potential client!!`;
    }
    if (firstName === "") {
      greeting = "Hello from AWO Stem Coaching!";
    }
    else {
  ...
  async confirmVerificationCode(code, req_id) {
    ...
    if (resData.result.status === "0") {
      ...
      window.alert("Partner quota exceeded. Kindly Contact awostemcoaching to report this problem");
    }
                  ...
                  <form>
                    <div className="row">
                      <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                        ...
                        <div className="form-group">
                          <input type="name" className="form-control userInput light full-width" placeholder='Preferred name' onChange={(e) => this.onTypedInputsChangeHandler(e)} value={this.state.clientProfile.businessName} name="businessName" />
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                          ...
                          <input className='btn btn-primary' style={{ width: "100%", border: "2px solid white" }} value="I prefer to communicate online (email/G-Meet)" id="Email" name="Email" onClick={() => this.chooseOption1("Email")} readOnly /><br></br>
