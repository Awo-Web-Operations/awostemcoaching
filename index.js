...
app.use('/awo_stem_coaching_form', express.static(path.join(__dirname, 'awo_stem_coaching_form/')))

app.get('/awo_stem_coaching_form/', function (req, res) {
  console.log("Comes in get of form");
  res.sendFile(path.join(__dirname, 'awo_stem_coaching_form/', 'index.html'));
});
